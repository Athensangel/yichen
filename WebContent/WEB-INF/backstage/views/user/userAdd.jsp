...
<html>
	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="${pageContext.request.contextPath}/back/user/save" method="post">
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
						<button class="layui-btn" type="submit" tlay-filter="demo1">立即提交</button>
