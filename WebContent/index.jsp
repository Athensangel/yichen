...
<jsp:include page="common/menu.jsp" flush="true" /> 
    <div class="index-box">
    	<div class="index-box-up">
        	<div class="index-box-left">
            	<div class="box-nav">
                    <div class="box-nav-left"><img src="${pageContext.request.contextPath}/images/11.png" width="149"/></div>
                    <div class="box-nav-right"><a href="text.html">+MORE</a></div>
                </div>
                <img src="${pageContext.request.contextPath}/images/001.png" width="500"/>
                <div class="box-img">
                	<img src="${pageContext.request.contextPath}/images/1.png" width="156"/>
            ...
            <div class="box-nav">
                    <div class="box-nav-left"><img src="${pageContext.request.contextPath}/images/12.png" width="149"/></div>
                    <div class="box-nav-right"><a href="text.html">+MORE</a></div>
                </div>
                <img src="${pageContext.request.contextPath}/images/001.png" width="470"/>
                <div class="box-img">
                	<img src="${pageContext.request.contextPath}/images/1.png" width="156"/>
    ...
    <div class="pic">
        <div class="pic-pic">
            <a href="pic.html"><img src="${pageContext.request.contextPath}/images/pic.png" width="159"/></a>
            <a href="pic.html"><img src="${pageContext.request.contextPath}/images/pic.png" width="159"/></a>
            <a href="pic.html"><img src="${pageContext.request.contextPath}/images/pic.png" width="159"/></a>
            <a href="pic.html"><img src="${pageContext.request.contextPath}/images/pic.png" width="159"/></a>
        </div>
